...
group :development, :test do
  ...
  gem 'capybara' #features for integration testing that doesn't come with rspec
  gem 'factory_bot_rails' #fast creation of objects 
...
group :development do
  ...
  gem 'guard' #listen to changes to the file system
  gem 'guard-rspec'#listen to changes 
end
